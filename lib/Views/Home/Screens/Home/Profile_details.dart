...
class ProfileDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double datainMeter = GetLocation.DistanceInMeters(
      ...
      double.parse(
          Get.find<Home_page_controller>().userModel.latitude.toString()),
      double.parse(
          Get.find<Home_page_controller>().userModel.longitude.toString()),
    );
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                          ...
                          children: [
                            ...
                            appData.entitlementIsActive
                                ? Expanded(
                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                        ChatRoomModel? chatRoom = await Get
                                                .find<Home_page_controller>()
                                            .getchatRoomPremium(id, context);
                          ...
                          child: Wrap(
                            ...
                            children: List.generate(interests!.length, (index) {
                              return Container(
                                ...
                                child: Text(interests![index].title.toString() +
                                    "  " +
                                    interests![index].image.toString()),
                              );
                            }),
                          ),
                        ),
                        ...
                        AppComponents().sizedBox20,
                        martial_status.toString() == "Never Married"
                            ? SizedBox.shrink()
                            : Align(
                                alignment: Alignment.topLeft,
                                child: Text(
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          Get.find<Home_page_controller>()
                              .ignorswap(
                                  opponent_user: model, visitType: "passed")
                              .then((value) => Get.back());
                        },
                        child: Container(
                            height: 50,
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.find<Home_page_controller>()
                              .likeswap(context, opponent_user: model)
                              .then((value) => Get.back());
                        },
                        child: Container(
                            height: 70,
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.find<Home_page_controller>()
                              .addtofavourite(opponent_user: model)
                              .then((value) => Get.back());
                        },
                        child: Container(
                            height: 50,
