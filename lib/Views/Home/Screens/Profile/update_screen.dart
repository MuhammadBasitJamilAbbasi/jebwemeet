...
class _Update_ScreenState extends State<Update_Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body: GetBuilder<EditProfileController>(
                ...
                children: [
                  ...
                  widget.username?  Column(
                    ...
                    children: [
                      ...
                      AppComponents().sizedBox30,
                      Center(
                        child:controller.isLoader? CircularProgressIndicator() : Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 10),
                          child: kAppButton(
                            buttonText: "Update",
                            onButtonPressed: () {
                              controller.updateProfile(context,parameter: "name",value: controller.nameController.value.text);
                            },
                          ),
                        ),
                      )
                      ...
                      Center(
                        child:controller.isLoader? CircularProgressIndicator() : Padding(
                          ...
                          child: kAppButton(
                            buttonText: "Update",
                            onButtonPressed: () {
                              controller.updateProfile(context,parameter: "job_title",value: controller.jobtitleController.value.text);
                            },
                          ),
                        ),
                      )
                      ...
                      Center(
                        child:controller.isLoader? CircularProgressIndicator() : Padding(
                          ...
                          child: kAppButton(
                            buttonText: "Update",
                            onButtonPressed: () {
                              controller.updateProfile(context,parameter: "about",value: controller.aboutController.value.text);
                      ...
                      Center(
                          child: Padding(
                            ...
                            child: kAppButton(
                              ...
                              onButtonPressed: () {
                                storage.box.write(kEducation, "Master’s degree");
                                setState(() {
                                });
                              },
                      ...
                      Center(
                        child:controller.isLoader? CircularProgressIndicator() : Padding(
                          ...
                          child: kAppButton(
                            buttonText: "Update",
                            onButtonPressed: () {
                              controller.updateProfile(context,parameter: "education",value: storage.box.read(kEducation));
                            },
                          ),
                        ),
                      )
                      ...
                      Center(
                          child: Padding(
                            ...
                            child: kAppButton(
                              ...
                              buttonText: "Divorced",
                              onButtonPressed: () {
                                storage.box.write(kMartial_Statius, "Divorced");
                                setState(() {
                                });
                              },
                            ),
                      ...
                      Center(
                          child: Padding(
                            ...
                            child: kAppButton(
                              ...
                              buttonText: "Widowed",
                              onButtonPressed: () {
                                storage.box.write(kMartial_Statius, "Widowed");
                                setState(() {
                                });
                              },
                            ),
                      ...
                      Center(
                          child: Padding(
                            ...
                            child: kAppButton(
                              ...
                              onButtonPressed: () {
                                storage.box.write(kMartial_Statius, "Prefer not to say");
                                setState(() {
                                });
                              },
                            ),
                      ...
                      Center(
                        child:controller.isLoader? CircularProgressIndicator() : Padding(
                          ...
                          child: kAppButton(
                            buttonText: "Update",
                            onButtonPressed: () {
                              controller.updateProfile(context,parameter: "martial_status",value: storage.box.read(kMartial_Statius));
                            },
                          ),
                        ),
                      )
                  ...
                  widget.childs? GetBuilder<RegisterController>(builder: (controller2){
                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Padding(
                        ...
                        Center(
                          child:controller.isLoader? CircularProgressIndicator() : Padding(
                            ...
                            child: kAppButton(
                              buttonText: "Update",
                              onButtonPressed: () {
                                controller.updateProfile(context,parameter: "childerns",value: controller2.selectedChild.toString());
                              },
                            ),
                          ),
                        )
                      ...
                      Center(
                        child:controller.isLoader? CircularProgressIndicator() : Padding(
                          ...
                          child: kAppButton(
                            buttonText: "Update",
                            onButtonPressed: () {
                              controller.updateProfile(context,parameter: "address",value: controller.selectedCity);
                            },
                          ),
                        ),
                      )
                      ...
                      Center(
                        child:controller.isLoader? CircularProgressIndicator() : Padding(
                          ...
                          child: kAppButton(
                            buttonText: "Update",
                            onButtonPressed: () {
                              controller.updateProfile(context,parameter: "caste",value: controller.selectedCaste);
                            },
                          ),
                        ),
                      )
                      ...
                      Center(
                        child:controller.isLoader? CircularProgressIndicator() : Padding(
                          ...
                          child: kAppButton(
                            buttonText: "Update",
                            onButtonPressed: () {
                              controller.updateProfile(context,parameter: "religion",value: controller.selectedReligion);
                            },
                          ),
                        ),
                      )
                  ...
                  widget.religion_practise? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: 15),
                      ...
                      Center(
                        child: buildProfileDropDown(
                            ...
                            onchange: (value) {
                              controller.selectedPractisingFunction(value.toString());
                            },
                            controller: controller),
                      ),
                      AppComponents().sizedBox30,
                      Center(
                        child:controller.isLoader? CircularProgressIndicator() : Padding(
                          ...
                          child: kAppButton(
                            buttonText: "Update",
                            onButtonPressed: () {
                              controller.updateProfile(context,parameter: "religious_practice",value: controller.selectedPractisingStatus);
                            },
                          ),
                        ),
                      )
                        ...
                        List.generate(topicContents!.length, (index) {
                          ...
                          return IntrinsicWidth(
                            child: InterestWidget(
                              textstyle: controller.getListt!.contains(topic)
                                  ? k14styleWhite
                                  : k14styleblack,
                              horizontalDistance: 15,
                              borderColor: controller.getListt!.contains(topic)
                                  ? primarycolor
                                  : Colors.grey.shade300,
                              image: topicContents![index].image!,
                              title: topicContents![index].title,
                              onTap: () {
                                if (!controller.getListt!.contains(topic)) {
                        ...
                        child:controller.isLoader? CircularProgressIndicator() : Padding(
                          ...
                          child: kAppButton(
                            ...
                            onButtonPressed: () {
                              ...
                              controller.updateProfile(context,parameter: "hobbies",value: controller.interestsList);
                            },
                          ),
                        ),
                      )
