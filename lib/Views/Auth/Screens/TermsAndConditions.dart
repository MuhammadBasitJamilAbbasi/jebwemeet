            ...
            Get.back();
              ...
              Padding(
                ...
                child: kAppButton(
                    buttonText: "I agree",
                    onButtonPressed: () {
                      final con = Get.find<GetSTorageController>();
                      if (con.box.read("isTerm") == "true" &&
                          con.box.read("isPolicy") == "true") {
                        Get.back();
                      } else {
                        showDialog(
                            context: context,
                            builder: (builder) {
                              return AlertDialog(
                                ...
                                title:  Text('Message',style: k18stylePrimary,),
                                content: Text(
                                    "Please agree to both the Terms and Conditions & Privacy Policy to procede"),
                                icon: Image.asset(
                                  "assets/appicon.png",
                                  height: 40,
                                  width: 40,
